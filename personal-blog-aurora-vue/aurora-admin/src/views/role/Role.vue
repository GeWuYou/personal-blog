...
export default {
  ...
  methods: {
    ...
    listRoles() {
      ...
      //     this.loading = false
      //   })
      _get('/admin/resource/role', {}, (data) => this.resources = data)
      // this.axios.get('/api/admin/role/resources').then(({ data }) => {
      //   this.resources = data.data
      // })
      _get('/admin/menu/role', {}, (data) => this.menus = data)
